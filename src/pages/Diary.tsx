...
import { saveHealthReport } from "../services/healthReportsService"
...
const DocumentSummarizer: React.FC = () => {
  ...
  const processDocument = async (selectedFile: File) => {
    ...
    try {
      ...
      const saveResult = await saveHealthReport(
        selectedFile.name,
      ...
      if (!saveResult.success) {
        console.error('Failed to save health report:', saveResult.error);
        // Don't fail the whole process, just log the error
      } else {
        console.log('Health report saved successfully:', saveResult.data);
      }
